    ...
    <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <Link to='/' class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                   <img src={logo} alt="" className='h-16 w-16'/> <Link to="/">Sports Shala</Link>
                </Link>
                <p class="mt-2 text-sm text-gray-500">Learn, Play and Professional!</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize xl:text-center">©Byomkesh 2023 All rights reserved </p>
            </div>
        </div>
    </footer>
    );
