  ...
  hideClass: {
    ...
    return (
        <div className='py-8 px-5'>
            <div className="content flex justify-around mx-auto items-center">
<div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12 p-12">
        <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            relative z-10">
          <p className="w-full text-3xl font-medium text-center leading-snug font-serif">Book Appointment For Support</p>
          <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
            ...
            <div className="relative">
              <a className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-blue-500
