              ...
              <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                ...
                >
                  Set Class Status
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <textarea name="feedback" id="feedback" cols="40" rows="5" className='border border-2 mt-5'></textarea>
                </div>
                <hr className='mt-8 ' />
                <div className='mt-2 flex mt-2 justify-around'>
                  <button
                    ...
                    onClick={() => setStatus("Approved")} type='submit'
                  >
                    Approved
                                    </button>
                                     <button
                    ...
                    onClick={() => setStatus("Denied")}  type='submit'
                  >
                    Denied
                  </button>
                </div>
